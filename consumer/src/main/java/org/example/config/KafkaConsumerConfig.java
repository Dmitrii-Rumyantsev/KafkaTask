...
public class KafkaConsumerConfig {
  ...
  public ConsumerFactory<String, Metric> consumerFactory() {
    ...
    props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Metric.class.getName());
    props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");

    return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new ErrorHandlingDeserializer<>(new JsonDeserializer<>(Metric.class, false)));
  }
